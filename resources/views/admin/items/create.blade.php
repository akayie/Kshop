...
<div class="container-fluid px-4">
                    <div class="my-3">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('backend.items.create')}}">Create Item</a></li>
                        </ol>
                            ...
                            <div class="card-body">
                                <form action="{{route('backend.items.store')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <input type="text" class="form-control @error('code_no') is-invalid @enderror" id="code_no" name="code_no" placeholder="">
                                        @error('code_no')
